...
# Remove any conflicting 'server' module before importing ours
...
def mock_qdrant_client():
    with patch.object(server, "get_qdrant_client") as mock:
...
def mock_get_text_embedding():
    with patch.object(server, "get_text_embedding") as mock:
